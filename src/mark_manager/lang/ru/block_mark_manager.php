...
$string['addinstanceroles'] = 'Роли, которым разрешено добавлять блок';
$string['addinstanceroles_desc'] = 'Пользователи с этими ролями смогут добавлять блок "Менеджер оценивания" на страницы курсов.';
