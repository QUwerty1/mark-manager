...
$string['addinstancerole'] = 'Роли, которым разрешено добавлять блок';
$string['addinstancerole_desc'] = 'Пользователи с этими ролями смогут добавлять блок "Менеджер оценивания" на страницы курсов.';
